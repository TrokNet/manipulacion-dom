...
export function invLePG_click(event) {
	GDC = a, PDC = a, PTC = a, GTC = a, PT = a, GTP = a, PTP = a, PDP = a, GDP = a, PD = a, C = a * 2, T = a * 2, M = a; //valor de los paños todo en leve
...
export function invMoPG_click(event) {
	...
	PD = a + 50, C = (a + 50) * 2, T = (a + 50) * 2, M = a + 50; //valor de los paños todos en moderado
...
export function invGraPG_click(event) {
	...
	PD = a + 100, C = (a + 100) * 2, T = (a + 100) * 2, M = a + 100; //valor de los paños todo en grave
